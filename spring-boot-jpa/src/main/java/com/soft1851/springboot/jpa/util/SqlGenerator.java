...
public class SqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        String packageName = "D:\\projects\\java\\spring-boot-review\\spring-boot-jpa\\src\\main\\java\\com\\soft1851\\springboot\\jpa\\model\\cascade";
        //生成sql的文件夹
        String filePath = "E:/data/Java";
        //项目中实体类的路径
        String prefix = "com.soft1851.springboot.jpa.model.cascade.";
        String className = "";
